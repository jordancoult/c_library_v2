...
typedef enum CELLULAR_CONFIG_RESPONSE
{
   ...
   CELLULAR_CONFIG_RESPONSE_ENUM_END=4, /*  | */
...
/** @brief Mode which signifies current morphing functionality. */
#ifndef HAVE_ENUM_MORPH_MODE
#define HAVE_ENUM_MORPH_MODE
typedef enum MORPH_MODE
{
   MORPH_MODE_DEMO=0, /* All of the arms move slowly through a cycle, covering their full ranges of motion. | */
   MORPH_MODE_QUAD_STATIC=1, /* The arms are in a quad-copter configuration and aren't moving. | */
   MORPH_MODE_TRI_STATIC=2, /* Three of the arms are in a tri-copter configuration and aren't moving. | */
   MORPH_MODE_TRANSITION=3, /* The drone briefly waits in quad position so CGF can stabilize before load-balancing is enabled. | */
   MORPH_MODE_QUAD_AUTO=4, /* Starting from a quad position, the four arms continually follow the estimated vehicle CG by utilizing CGF. Also known as "loab-balancing". | */
   MORPH_MODE_ENUM_END=5, /*  | */
} MORPH_MODE;
#endif
...
#include "./mavlink_msg_dynageo.h"
#include "./mavlink_msg_morph_status.h"
